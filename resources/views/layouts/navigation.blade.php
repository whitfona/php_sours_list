<nav x-data="{ open: false }" class="bg-pink-400">
    ...
    <!-- Primary Navigation Menu -->
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('sours.all')" :active="request()->routeIs('sours.all')">
                            {{ __('All Bevvies') }}
                        </x-nav-link>
                        <x-nav-link :href="route('sours.index')" :active="request()->routeIs('sours.index')">
                            {{ __('My Bevvies') }}
                        </x-nav-link>
                    </div>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-md font-medium text-white hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                ...
                <div class="-mr-2 flex items-center sm:hidden">
                    <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:text-white transition duration-150 ease-in-out">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('sours.all')" :active="request()->routeIs('sours.all')">
                    {{ __('All Bevvies') }}
...
@else
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Navigation Links -->
            <div class="max-w-lg text-right px-6 py-4 sm:block">
